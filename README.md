...
Полнофункциональная учебная система управления базами данных с end-to-end пайплайном выполнения SQL-запросов.
...
Создано **8 тестовых файлов** с **33+ тестами**:
- Unit тесты для всех компонентов (Lexer, Parser, Storage, Buffer, Index, Executor)
- End-to-end тесты (требуют запущенного сервера)
